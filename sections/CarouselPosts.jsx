...
const CarouselPosts = ({ type, categories, slug }) => {
  ...
  switch (type) {
    case 'releted':
      casesPostsFunc = getSimilarPosts(categories, slug);
      break;
    default: casesPostsFunc = getFeaturedPosts();
  }

  useEffect(() => {
    casesPostsFunc.then((result) => {
